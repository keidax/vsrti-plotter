...
public class Viewer extends JFrame implements ModelListener, ActionListener {
    ...
    public Viewer(Adapter a, String title) {
        ...
        lDelta = new JLabel("<HTML><P><B>f(t) Input Parameters:</P><P>" + '\u0394' + "t: </P><P># of points:</P><P> </P><P><B>Display Options:</B></P><P>max time: </P><P>max frequency: </P></HTML>");
        ...
        fMaxTime = new JTextField(adapter.getDeltaBaseline()*adapter.getNumberOfPoints() +""); //Max Time to be displayed
...
//                eqn.setMaximumSize(new Dimension(700,100));
    ...
    {
    	this.adapter.graphEquation(equation);
    }
