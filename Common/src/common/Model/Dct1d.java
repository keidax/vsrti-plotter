 ...
 * Processing - An Algorithmic Introduction using Java" by Wilhelm Burger and
 * Mark J. Burge, Copyright (C) 2005-2008 Springer-Verlag Berlin, Heidelberg,
 * New York. Note that this code comes with absolutely no warranty of any kind.
...
public class Dct1d {
    ...
    public Dct1d(int M) { // Constructor
