...
public class ClosedParenthesis implements Token {
    ...
    /**
     * Default Constructor, sets the precedence to 0 because precedence does not
     * affect parentheses.
     */
     ...
     * @return String of all the operators on the stack in order until it
     *         reaches an open parenthesis (which is not part of the String
     *         being returned)
     */
    @Override
