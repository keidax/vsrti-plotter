      ...
      bAvgBlocks.addActionListener(new ActionListener() {
        ...
        bReset.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
            	...
            	if(View.viewer.vGraph.graphTitle.equals("Spectrum: Antenna Temperature vs. Frequency") || View.viewer.vGraph.graphTitle.equals("Averge TA vs. Order"))
            		return;
                choosingDelete = false;
                ListNode node;
        ...
        bUndo.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent arg0) {
            	if(currentNode == null || View.viewer.vGraph.graphTitle.equals("Spectrum: Antenna Temperature vs. Frequency") || View.viewer.vGraph.graphTitle.equals("Averge TA vs. Order"))
            		return;
