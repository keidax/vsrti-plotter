...
public class LinkedList
{
    ...
    /**
     * returns the index of the listNode with the value passed in
     * returns -1 if the string is not in the LinkedList
     * @param value the key of the ListNode being searched for
     */
     ...
     * 
     * @param the value of the node being removed
     */
    public void remove(String titl)
    {
    	int index = this.getIndex(titl);
    	ListNode node;
