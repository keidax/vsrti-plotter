...
public class ListNode
{
    ...
    public ListNode(String t, double[] d, double startFreq, double stepFreq)
    {
    	this.title = t;
        this.data = d;
        this.fStart = startFreq;
        this.fStep = stepFreq;
        this.deleted = new double[d.length];
        this.endChannels = new double[d.length];
        this.angle = 0;
        
        
    }
    
    public ListNode(String t, double[] d, double startFreq, double stepFreq, double[] del, double[] end)
    {
    	this.title = t;
        this.data = d;
        this.fStart = startFreq;
    ...
    {
       String returning = title + "\n" + "0 0 0 0 0 " + fStart + " " + fStep + " " + 0 + " " + data.length;
