        ...
        try {
            ...
            while ((strLine = br.readLine()) != null) {
                ...
                if (strLine.trim().startsWith("*lambda")) {
                    ...
                    JOptionPane.showMessageDialog(viewer,"Incorrect file format. Try to drag-and-drop files into drag-and-drop table area.","Incorrect format",JOptionPane.ERROR_MESSAGE);
                    return null;
                }
